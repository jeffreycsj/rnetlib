...
install -m 0644 examples/cpp/game_echo_smoke.cpp "${destination}/examples/cpp/game_echo_smoke.cpp"
install -m 0644 examples/cpp/game_range_smoke.cpp "${destination}/examples/cpp/game_range_smoke.cpp"
